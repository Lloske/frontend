...
const routes: Routes = [
  ...
  { path : "", redirectTo: "/public-area", pathMatch : "full" }, // Redirige la racine de l'application vers "/public-area" avec une correspondance de chemin exacte (pas pathMath: "prefix" sinon tout ce qui se site apres la racine "/"" redirige vers "/public-area").
  ...
  { path : "member-area", loadChildren : () => import("./features/member-area/member-area.module").then(m => m.MemberAreaModule) }, 
